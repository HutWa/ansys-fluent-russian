...
**Переведено 12 031 из 28 786 строк Fluent — 41,8 % интерфейса Fluent Student 2026 R1.**
...
| Требует редакторской проверки | 230 |
| Не переводится | 555 |
| Ещё не добавлено в каталог проекта | 15 805 |
