...
**Переведено 23 000 из 28 786 строк Fluent — 79,9 % интерфейса Fluent Student 2026 R1.**
...
| Не переводится | 555 |
| Ещё не добавлено в каталог проекта | 4 992 |
...
**Лента Fluent (`Ribbon/*`): 1 149 из 1 149 строк переведены.** Это охватывает вкладки «Файл», «Домен», «Физика», «Пользовательские», «Решение», «Результаты», «Вид», «Параллельные вычисления», «Проектирование», «Параметрические» и «Обучение и поддержка», а также их команды.
