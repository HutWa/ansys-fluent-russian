...
На скриншоте предыдущей установленной сборки верхняя лента ещё отображалась на английском. Полный пакет из текущего каталога уже собран и установлен в тестовую Fluent Student, но ленту в нём ещё требуется открыть и проверить визуально.
