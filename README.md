...
| Требует редакторской проверки | 74 |
| Не переводится | 555 |
| Ещё не добавлено в каталог проекта | 4 981 |
...
На скриншоте предыдущей установленной сборки верхняя лента ещё отображалась на английском. Поэтому после следующей сборки и установки требуется повторно открыть Fluent и проверить её визуально.
